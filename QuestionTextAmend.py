...
class  QuestionTextAmend:
    def __init__(self,root,isTKroot = True):
        ...
        Text_2.configure(relief = "sunken", font=("SHS Monaco Adjusted", 9))
        ...
        ListBox_10_Scrollbar.place(x = 100,y = 0,width = 20,height = 130)
        ...
        Fun.SetControlPlace(uiName,'Button_11',138,68,48,30)
